...
var noRestrictedImportsRule =
  {
    paths: [
      ...
      { name: '@nestjs/common', importNames: ['LoggerService'], message: 'Use "~common/logging" instead' },
    ],
    patterns: [
  ...
  rules: {
    ...
    'import-helpers/order-imports': [
      'error',
      {
        ...
        groups: ['module', '/^~vendors/', '/^~common/', '/^~database/', '/^~/', ['parent', 'sibling', 'index']],
