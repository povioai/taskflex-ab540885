...
import { TransformInputToArray } from './transformers/input-to-array.transform';
import { TransformInputToBoolean } from './transformers/input-to-boolean.transform';
...
describe('ClassValidator', () => {
  it('ClassValidator Happy Path', () => {
    testClassValidator(AnDto, {
  ...
  it('ClassValidator Invalid Input', () => {
    testClassValidator(AnDto, {
      ar1: { value: 'hello; world', transformed: true, value2: ['hello; world'] },
      ar2: { transformed: true, value2: ['the', 'default'] },
      ar3: {
